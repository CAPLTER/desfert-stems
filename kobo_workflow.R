...
# logggin data are accessed separately.
...
path <- "~/Dropbox/development/desfert_stems_spring/desfert_stems_-_all_versions_-_English_en_-_2022-06-10-18-39-33.xlsx"
...
# STEP 3: fix plot-level errors (if needed)

# here fixing data for a plot so we need to go back and recreate plots_plants
# after running this; this error was identifed from the complete_matrix
...
remove_ambiguous_plants(67, "L2", "L3", "2022-05-24")
